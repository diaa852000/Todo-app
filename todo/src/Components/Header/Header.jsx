...
const Header = ({children, openModal, closeModal, isOpenModal, onIsOpenChange}) => {
    ...
    return (
        <div className='max-w-[1240px] mx-auto px-2 py-2 md:py-5'>
            ...
            <div className='flex justify-evenly md:justify-evenly items-center fixed bottom-20 right-[5%] md:right-[17%] 2xl:right-[28%]'>
                <button 
                    onClick={handleOpenModal}
                    type='button' 
                    className='capitalize text-white font-poppins font-medium text-sm w-10 h-10 flex justify-center items-center rounded-full border-2 border-transparent transition-all duration-200 ease-in-out
